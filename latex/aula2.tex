...
\begin{frame}{Objetivos de aprendizagem}
  ...
  \begin{alertblock}{Pré-requisitos}
    Aula 1 --- Internet: camadas TCP/IP, endereçamento IP, capa de enlace e comutação de pacotes.
  \end{alertblock}
\end{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.45\textwidth}
      ...
      \begin{tikzpicture}[font=\scriptsize,
        ...
        \node[capa,below=4mm of v](o){Oxigênio\\ pico 60~GHz};
        \node[capa,below=4mm of o](c){Chuva/névoa\\ dispersão};
      \end{tikzpicture}
      \end{center}
    \end{column}
  \end{columns}

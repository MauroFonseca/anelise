...
\begin{frame}{Duplexação e formatos de slot}
  ...
  \begin{center}
    ...
    \end{tikzpicture}\\[1mm]
    {\scriptsize \textbf{Figura 4:} configuração TDD com slots de downlink (D), uplink (U) e flexível (S).}
  \end{center}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{center}
        ...
        \end{tikzpicture}\\[1mm]
        {\scriptsize \textbf{Figura 5:} dual connectivity: o UE agrega o nó mestre e o secundário.}
      \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}{PDU sessions, QoS flows e DRBs}
  ...
  \begin{center}
    ...
    \end{tikzpicture}\\[1mm]
    {\scriptsize \textbf{Figura 6:} uma PDU session transporta três QoS flows (voz GBR, eMBB e URLLC) sobre DRBs distintos.}
  \end{center}
  ...
  \begin{columns}
    ...
    \begin{column}{0.48\textwidth}
      \begin{center}
        ...
        \end{tikzpicture}\\[1mm]
        {\scriptsize \textbf{Figura 7:} handover Xn (direto) e N2 (via núcleo).}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
    ...
    \begin{column}{0.5\textwidth}
      \begin{center}
        \begin{tikzpicture}[font=\tiny,>=Stealth]
          ...
          \draw[<->,thick] (upf) -- (cl);
        \end{tikzpicture}\\[1mm]
        {\scriptsize \textbf{Figura 8:} MEC na borda da RAN, com \emph{local breakout} no UPF.}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
